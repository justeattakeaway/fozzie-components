...
Some parts of a user journey require data before we can begin automation testing. For example, in order to complete end to end tests for the checkout page, we would first need to acquire user authentication (unless guest), restaurants, menus and more.
