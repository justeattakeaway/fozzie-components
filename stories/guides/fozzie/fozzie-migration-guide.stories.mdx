...
[Gulp build fozzie](https://github.com/justeat/gulp-build-fozzie) is a set of Gulp tasks used across Fozzie modules. If your application uses this to build packages, instead of Webpack, you will need to firstly update to the latest version (v11.0.0). Version 11.0.0 removes a package called eyeglass which essentially creates a shortcut to your `node_modules` folder.
