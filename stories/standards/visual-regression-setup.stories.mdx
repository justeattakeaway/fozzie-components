...
Once you have added this, to allow your PR to run the visual tests on CI, you'll also need to add this line below to your component's `package.json` prefacing 'YOUR_COMPONENT_TYPE_HERE' with either `atom`, `molecules`, `organisms` or `pages`.
