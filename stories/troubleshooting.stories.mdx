...
- Read more about yalc and find installation instructions here - https://github.com/whitecolor/yalc
...
- Once installed you can run `yalc publish --push` in any component
- Once published locally you can run `yalc add @justeat/f-myComponentName` in any NPM based project
- Assets should be automatically updated when you change the component
