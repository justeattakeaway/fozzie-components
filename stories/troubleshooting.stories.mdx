...
- You can read more about yalc and find installation instructions here - https://github.com/whitecolor/yalc
...
- Once published locally you can run `yalc add @justeat/f-myComponentName` in any NPM based project
- You will need to republish and add each time you modify the component

### How can I create a new component?
> We have streamlined the process for creating new components; but we would recommend talking to the team before you do

1. If you haven't already, run the `First time setup` steps at the top of this page
2. Navigate your terminal to the generator folder: `cd /packages`
...
- WebDriver does not support the import export syntax in the most recent ES versions
- When writing code that is directly imported by WebDriver code, make sure to use `require` and `module.exports` based syntax in your code
...
1. Make sure that your PR includes version bumps and change log entries for the affected components
