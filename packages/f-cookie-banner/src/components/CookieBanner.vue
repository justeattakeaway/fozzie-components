<template>
    <div class="cpBanner">
        <div
            id="dialog1"
            class="cpBanner-content"
            role="dialog"
            aria-labelledby="cookieConsentLabel"
            aria-modal="true">
            <h2
                id="cookieConsentLabel"
                class="cpBanner-title">
                <a
                    name="cookieConsentTitle"
                    tabindex="-1"
                    data-consent-title>${content.mainTitle}</a>
            </h2>
            <p class="cpBanner-text">
                ${content.text1}
            </p>
            <p class="cpBanner-text">
                ${content.text2}
            </p>
            <p class="cpBanner-text cpBanner-text--last">
                ${content.text3}
                <a
                    href="${content.linkHref}"
                    class="cpBanner-link"
                    target="_blank">${content.linkText}</a>
                ${content.text4}
            </p>
        </div>
        <div class="cpBanner-CTA">
            <button
                class="cpBanner-button cpBanner-button--accept"
                tabindex="0"
                role="button"
                data-button-accept>
                ${content.buttonText2}
            ...
            <button
                class="cpBanner-button cpBanner-button--nonAccept"
                tabindex="0"
                role="button"
