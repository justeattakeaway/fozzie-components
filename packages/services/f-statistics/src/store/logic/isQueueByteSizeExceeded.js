...
/**
* Compares queue array byte size using Blob against config value. Returns true if the number of items is equal or greater than config.BATCH_QUEUE_MAX_BYTES
 *
