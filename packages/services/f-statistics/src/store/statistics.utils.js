import { IS_BATCH_PUBLISHING_ENABLED, BATCH_QUEUE_SIZE } from '../config';
import {
    CLEAR_PUBLISH_QUEUE, SET_INTERVAL_TIMER, CLEAR_INTERVAL_TIMER
} from './mutation-types';
 ...
 */
export const isQueueLengthExceeded = queue => queue.length >= BATCH_QUEUE_SIZE;
...
/**
  ...
  */
export const publishQueue = (queue, commit, justLog) => {
...
/**
  ...
  * @param {object} justLog - Instance of JustLog
  */
export const startBatchPublishTimer = ({ queue, interval }, commit, justLog) => {
...
/**
  ...
  * @param {object} justLog - Instance of JustLog
  */
export const shouldPublishQueuedLogs = ({ queue }, commit, justLog) => {
