...
export default {
  ...
  render: function render(h, ctx) {
    ...
    return h("svg", _mergeJSXProps([{
      ...
      "class": "c-ficon c-ficon--app-android.es"
    }, ctx.data]), [h("path", {
      attrs: {
