...
import BaseContentCards, { CARDSOURCE_METADATA, CARDSOURCE_CUSTOM } from '../BaseContentCards.vue';
...
describe('BaseContentCards', () => {
    allure.feature('Base Content Cards');

    it('should call intitialiseMetadata when mounted', () => {
        // Arrange & Act
        shallowMount(BaseContentCards, {
            propsData: {
                apiKey,
                userId
            },
    ...
    it('should handle rejections from the promise returned by intitialiseMetadata by emitting an onError event', async () => {
        ...
        // Act
        const instance = shallowMount(BaseContentCards, {
            propsData: {
                apiKey,
                userId
            },
    ...
    describe('emitters', () => {
        ...
        const testEmitter = async (emitter, expectedArgs) => {
            // Arrange
            const instance = await shallowMount(BaseContentCards, {
                propsData: {
                    apiKey,
                    userId
                },
