...
| `cardHeadingSize`         | `String`   |  No        | `''`    | Overrides the default heading size for the card component's heading.<br><br>Allowed values are `''`, `alpha`, `beta`, `gamma`, `delta`, `epsilon` and `zeta` |
