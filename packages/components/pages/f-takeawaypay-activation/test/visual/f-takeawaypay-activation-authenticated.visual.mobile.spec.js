...
describe('f-takeawaypay-activation - Authenticated - Mobile Visual Tests', () => {
    ...
    .it('should display user details when the user is logged in and tenant is "%s"', async tenant => {
        ...
        // Assert
        await browser.percyScreenshot(`f-takeawaypay-activation - Authenticated - ${tenant}`, 'mobile');
    });
    ...
    .it('should display a successful message when the activation is successful and tenant is "%s"', async tenant => {
        ...
        // Assert
        await browser.percyScreenshot(`f-takeawaypay-activation - Successful activation - ${tenant}`, 'mobile');
    });
});
