const messages = {
    ...
    textLine3: 'For nærmere oplysninger om de anvendte cookies og teknologier henviser vi til vores {cookiePolicy}. Ved brug af denne banner placeres en cookie på din enhed, som husker dine præferencer.',
