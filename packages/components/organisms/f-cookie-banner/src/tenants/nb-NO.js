const messages = {
    ...
    textLine3: 'For detaljer om hvilke informasjonskapsler og teknologier vi bruker, se vår {cookiePolicy}. Ved å bruke dette banneret, plasseres en informasjonskapsel på enheten din for å huske dine preferanser.',
