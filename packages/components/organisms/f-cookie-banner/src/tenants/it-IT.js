const messages = {
    ...
    textLine3: 'Per i dettagli sui cookie e sulle tecnologie che utilizziamo puoi leggere {cookiePolicy}. L\'utilizzo di questo banner imposter&aacute; un cookie sul tuo dispositivo per ricordare le tue preferenze.',
