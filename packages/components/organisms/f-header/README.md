...
| headerBackgroundTheme     | `String`      | `white` | Sets the background theme for the header component.<br><br>When set to `white` the header will be white with the default logo colour.<br>When set to `transparent` the header will be transparent with a white logo.<br>When set to `highlight` the header will use the primary brand colour as the background colour with a white logo.<br>When set to `disappearingWhite` the header will be transparent with with the default logo colour on wide screens, and white with box-shadow at the bottom of the header on narrow screens.  |
