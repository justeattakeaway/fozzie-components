    ...
    <nav
        ...
        <button
            :class="[
                ...
                $style['c-nav-trigger'],
                $style['c-nav-toggle'],
                { [$style['c-nav-toggle--altColour']]: isNavToggleAltColour },
...
export default {
    ...
    computed: {
        ...
        isNavToggleAltColour () {
            return ['highlight', 'search'].includes(this.headerBackgroundTheme) ||
            (this.headerBackgroundTheme === 'transparent' && !this.navIsOpen);
        },
