...
export const DOWNLOAD_ICONS = '[class="c-footer-list c-footer-list--inline c-footer-list--noBottomMargin"] a';
export const SOCIAL_ICONS = '[class="c-footer-list c-footer-list--inline"] a';
