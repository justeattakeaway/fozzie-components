...
export const INVALID_MODEL_STATE_ERRORS = ['FIRST_NAME_REQUIRED', 'LAST_NAME_REQUIRED', 'PHONE_NUMBER_REQUIRED', 'DATE_OF_BIRTH_REQUIRED', 'ADDRESS_LINES_REQUIRED', 'POSTAL_CODE_REQUIRED', 'GEO_LOCATION_REQUIRED'];
export const INVALID_ORDER_TIME_ERROR = ['FULFILMENT_TIME_UNAVAILABLE'];
export const SET_ORDER_TIME_ERROR = ['FULFILMENT_TIME_REQUIRED'];

export const UPDATE_CHECKOUT_ERRORS = {
