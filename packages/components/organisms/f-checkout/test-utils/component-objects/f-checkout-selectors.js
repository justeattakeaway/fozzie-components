...
exports.AGE_VERIFICATION_DAY_DROPDOWN_OPTIONS = '[data-test-id="formfield-dob-day-dropdown-select"] option';
exports.AGE_VERIFICATION_MONTH_DROPDOWN = '[data-test-id="formfield-dob-month-dropdown-select"]';
exports.AGE_VERIFICATION_MONTH_DROPDOWN_OPTIONS = '[data-test-id="formfield-dob-month-dropdown-select"] option';
exports.AGE_VERIFICATION_YEAR_DROPDOWN = '[data-test-id="formfield-dob-year-dropdown-select"]';
exports.AGE_VERIFICATION_YEAR_DROPDOWN_OPTIONS = '[data-test-id="formfield-dob-year-dropdown-select"] option';
exports.FIELDS = {
    firstName: {
