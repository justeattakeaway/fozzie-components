...
export default {
    ...
    render (h, ctx) {
        ...
        return h('svg', _mergeJSXProps([{
            ...
            class: 'c-ficon c-ficon--bag-sad-bg'
        }, ctx.data]), [h('path', {
            attrs: {
                d: 'm10.58 29.23 16.55 88.6 111.1-68.08L10.58 29.23Z',
                fill: '#C9ECF2'
            }
        }), h('path', {
            attrs: {
                d: 'M68.1 45.77c-4.6-1.89-9.13 1.55-10.62 5.83-1.48 4.26-.09 9.98 4.53 11.6.94.33 1.35-1.16.4-1.5-3.8-1.34-4.61-6.3-3.44-9.68 1.25-3.57 4.92-6.31 8.73-4.75.93.39 1.33-1.12.41-1.5Z',
                fill: '#4C4C4C'
            }
        }), h('path', {
            attrs: {
                d: 'M67.58 47.18c.48 1.08 1.44 1.89 2.67 1.85a2.7 2.7 0 0 0 2.5-2.01c.3-.96-1.2-1.36-1.49-.41-.17.55-.63.93-1.22.86-.6-.07-.9-.56-1.12-1.07-.41-.91-1.75-.12-1.34.77v.01Z',
                fill: '#4C4C4C'
            }
        }), h('path', {
            attrs: {
                d: 'M68.32 47.28c.89.59 1.76-.25 2.28-.92.52-.67.81-1.7.23-2.46-.25-.34-.67-.51-1.06-.28-.33.2-.53.72-.28 1.06.18.23.11.4-.04.64a2.58 2.58 0 0 1-.48.56c-.13.07-.08.09.14.06-.83-.55-1.61.8-.77 1.34h-.02Z',
                fill: '#4C4C4C'
            }
        }), h('path', {
            attrs: {
                d: 'M69.2 46.6c.47-1.28-.07-2.8-1.55-2.93-.42-.04-.78.39-.78.78.01.42.36.76.78.77.38.04.12.83.06.97-.14.4.17.85.55.96.4.1.83-.14.95-.54Z',
                fill: '#4C4C4C'
            }
        }), h('path', {
            attrs: {
                d: 'm63.4 53.88-2.32 15.54-3.42 5.06 4.13 6.7-6.11 6.04-11.29.41 4.16 18.59.69.51h50.19s3.9-9.53 4.63-11.23l4.61-10.68.32-16.88 1.55-3.4-6.36-8.94-10.39 1.63-16.35-2.94-4.32-.14-1.56-.13-1.2.15-6.95-.3Z',
                fill: '#fff'
            }
        }), h('path', {
            attrs: {
                d: 'm48.59 106.74-4.2-19.1s13.6-.58 16.2-.04c2.6.53 12.6 1.95 14.18 2.16 1.57.2 6.08-.46 6.08-.46l4.7-.77 7.92.72 4.74-4.58 1.63-4.63-.94-9.51 3.15-8.09 2.13-6.85 6.36 8.95-1.4 4.23v15.5L98.9 106.74H48.6Z',
                fill: '#FF8000'
            }
        }), h('path', {
            attrs: {
                d: 'M72 80.48a44.34 44.34 0 0 1 5.49-6.83c.41-.31.64-.22 1.12-.09 1.56.41 3 1.2 4.2 2.28a22.77 22.77 0 0 1 2.88 3.55c.58.81 1.92.04 1.34-.77-1.04-1.48-2.1-3-3.49-4.19a11.83 11.83 0 0 0-5-2.48c-.82-.2-1.4-.1-2.03.48a47.7 47.7 0 0 0-5.86 7.27c-.55.84.8 1.62 1.34.78Z',
                fill: '#FF8000'
            }
        }), h('path', {
            attrs: {
                d: 'M73.63 81.15c.35-.1.71-.14 1.07-.1l-.74-.98c-.3.93-.96 2.7-.42 3.63.66 1.17 2.13.1 3.04-.02 1.44-.18 2.73.63 4.16.55 1.36-.08 2.64-.69 4.02-.52.55.06.82-.55.75-.99-.2-1.2-.5-2.39-.92-3.54l-.54.96a17.2 17.2 0 0 0 2.5-.61c.94-.3.54-1.8-.42-1.5-.81.27-1.65.47-2.49.61a.78.78 0 0 0-.54.96c.41 1.15.72 2.33.91 3.54l.75-.98c-1.8-.22-3.49.83-5.28.37-.83-.22-1.64-.46-2.52-.43-.4.01-.8.06-1.18.15-.42.1-1.01.47-1.43.44l.55.23c-.07-.07.18-1.01.2-1.17.1-.42.22-.84.35-1.26.16-.52-.27-.94-.75-.98-.5-.05-1 0-1.49.15-.96.27-.55 1.77.41 1.5v-.01Z',
                fill: '#FF8000'
            }
        }), h('path', {
            attrs: {
